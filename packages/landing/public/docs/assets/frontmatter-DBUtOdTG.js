const e={frontmatter:{title:"Frontmatter",description:"Reference for all YAML frontmatter fields supported in Tome documentation pages.",icon:"file-text",hidden:!1,toc:!0,draft:!1},html:`<p>Every Tome page can include YAML frontmatter at the top of the file. Frontmatter controls metadata like the page title, description, sidebar behavior, and search tags.</p>
...
<td><code>boolean</code></td>
<td><code>false</code></td>
<td>Mark as draft — visible in dev, excluded from production builds</td>
</tr>
<tr>
<td><code>badge</code></td>
<td><code>string | { text: string; variant?: "default" | "outline" | "info" | "warning" | "success" | "danger" }</code></td>
<td>—</td>
<td>Badge shown next to the page title in sidebar navigation</td>
</tr>
</tbody>
</table>
...
<li>Pages shared only via direct link</li>
</ul>
<p>Note that hidden pages still exist in production and can be reached by anyone with the URL. To fully exclude a page from production, use <code>draft: true</code> instead.</p>
<h2 id="draft-pages"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#draft-pages"><span class="icon icon-link"></span></a>Draft pages</h2>
<p>Pages with <code>draft: true</code> are completely removed from production builds. Unlike <code>hidden</code>, drafts don't exist at all in production — not even via direct URL.</p>
<p>In dev mode, draft pages are still visible so you can preview them, and they display a "DRAFT" banner at the top of the page to remind you they won't be published.</p>
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">---</span></span>
...
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">---</span></span>
<span class="line"></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">This page is only visible during local development.</span></span></code></pre>
<h2 id="badges"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#badges"><span class="icon icon-link"></span></a>Badges</h2>
<p>The <code>badge</code> field adds a colored pill next to the page title in sidebar navigation. This is useful for marking pages as new, beta, deprecated, and so on.</p>
<p>A simple string value creates a badge with the default style:</p>
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">---</span></span>
<span class="line"><span style="color:#22863A;--shiki-dark:#85E89D">title</span><span style="color:#24292E;--shiki-dark:#E1E4E8">: </span><span style="color:#032F62;--shiki-dark:#9ECBFF">Streaming API</span></span>
<span class="line"><span style="color:#22863A;--shiki-dark:#85E89D">badge</span><span style="color:#24292E;--shiki-dark:#E1E4E8">: </span><span style="color:#032F62;--shiki-dark:#9ECBFF">"New"</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">---</span></span></code></pre>
<p>For more control, pass an object with <code>text</code> and an optional <code>variant</code>:</p>
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">---</span></span>
<span class="line"><span style="color:#22863A;--shiki-dark:#85E89D">title</span><span style="color:#24292E;--shiki-dark:#E1E4E8">: </span><span style="color:#032F62;--shiki-dark:#9ECBFF">Legacy Auth</span></span>
<span class="line"><span style="color:#22863A;--shiki-dark:#85E89D">badge</span><span style="color:#24292E;--shiki-dark:#E1E4E8">:</span></span>
<span class="line"><span style="color:#22863A;--shiki-dark:#85E89D">  text</span><span style="color:#24292E;--shiki-dark:#E1E4E8">: </span><span style="color:#032F62;--shiki-dark:#9ECBFF">"Beta"</span></span>
<span class="line"><span style="color:#22863A;--shiki-dark:#85E89D">  variant</span><span style="color:#24292E;--shiki-dark:#E1E4E8">: </span><span style="color:#032F62;--shiki-dark:#9ECBFF">"warning"</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">---</span></span></code></pre>
<p>Available variants: <code>default</code>, <code>outline</code>, <code>info</code>, <code>warning</code>, <code>success</code>, <code>danger</code>. Each variant applies a different background and text color that matches the current theme.</p>
