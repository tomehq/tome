const n={frontmatter:{title:"Pages & Routing",description:"How Tome maps files in the pages/ directory to URLs — naming conventions, nested routes, i18n, and versioning.",icon:"map",hidden:!1},html:`<h1 id="pages--routing"><a class="heading-anchor" aria-hidden tabindex="-1" href="#pages--routing"><span class="icon icon-link"></span></a>Pages &#x26; Routing</h1>
<p>Every <code>.md</code> or <code>.mdx</code> file in the <code>pages/</code> directory becomes a page. The file path determines the URL.</p>
