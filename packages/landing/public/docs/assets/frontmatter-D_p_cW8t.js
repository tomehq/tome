const e={frontmatter:{title:"Frontmatter",description:"Reference for all YAML frontmatter fields supported in Tome documentation pages.",icon:"file-text",hidden:!1},html:`<h1 id="frontmatter"><a class="heading-anchor" aria-hidden tabindex="-1" href="#frontmatter"><span class="icon icon-link"></span></a>Frontmatter</h1>
<p>Every Tome page can include YAML frontmatter at the top of the file. Frontmatter controls metadata like the page title, description, sidebar behavior, and search tags.</p>
