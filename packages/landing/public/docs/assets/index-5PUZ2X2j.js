(function(){const T=document.createElement("link").relList;if(T&&T.supports&&T.supports("modulepreload"))return;for(const _ of document.querySelectorAll('link[rel="modulepreload"]'))s(_);new MutationObserver(_=>{for(const j of _)if(j.type==="childList")for(const R of j.addedNodes)R.tagName==="LINK"&&R.rel==="modulepreload"&&s(R)}).observe(document,{childList:!0,subtree:!0});function h(_){const j={};return _.integrity&&(j.integrity=_.integrity),_.referrerPolicy&&(j.referrerPolicy=_.referrerPolicy),_.crossOrigin==="use-credentials"?j.credentials="include":_.crossOrigin==="anonymous"?j.credentials="omit":j.credentials="same-origin",j}function s(_){if(_.ep)return;_.ep=!0;const j=h(_);fetch(_.href,j)}})();function Th(d){return d&&d.__esModule&&Object.prototype.hasOwnProperty.call(d,"default")?d.default:d}var qu={exports:{}},li={};/**
 * @license React
 ...
 */var Nf;function _h(){if(Nf)return li;Nf=1;var d=Symbol.for("react.transitional.element"),T=Symbol.for("react.fragment");function h(s,_,j){var R=null;if(j!==void 0&&(R=""+j),_.key!==void 0&&(R=""+_.key),"key"in _){j={};for(var L in _)L!=="key"&&(j[L]=_[L])}else j=_;return _=j.ref,{$$typeof:d,type:s,key:R,ref:_!==void 0?_:null,props:j}}return li.Fragment=T,li.jsx=h,li.jsxs=h,li}var Gf;function Eh(){return Gf||(Gf=1,qu.exports=_h()),qu.exports}var u=Eh(),Nu={exports:{}},te={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zf;function Ch(){if(Zf)return st;Zf=1;var d=Ju();function T(O){var x="https://react.dev/errors/"+O;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var Z=2;Z<arguments.length;Z++)x+="&args[]="+encodeURIComponent(arguments[Z])}return"Minified React error #"+O+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function h(){}var s={d:{f:h,r:function(){throw Error(T(522))},D:h,C:h,L:h,m:h,X:h,S:h,M:h},p:0,findDOMNode:null},_=Symbol.for("react.portal");function j(O,x,Z){var w=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:_,key:w==null?null:""+w,children:O,containerInfo:x,implementation:Z}}var R=d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function L(O,x){if(O==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return st.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,st.createPortal=function(O,x){var Z=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(T(299));return j(O,x,null,Z)},st.flushSync=function(O){var x=R.T,Z=s.p;try{if(R.T=null,s.p=2,O)return O()}finally{R.T=x,s.p=Z,s.d.f()}},st.preconnect=function(O,x){typeof O=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,s.d.C(O,x))},st.prefetchDNS=function(O){typeof O=="string"&&s.d.D(O)},st.preinit=function(O,x){if(typeof O=="string"&&x&&typeof x.as=="string"){var Z=x.as,w=L(Z,x.crossOrigin),W=typeof x.integrity=="string"?x.integrity:void 0,P=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;Z==="style"?s.d.S(O,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:w,integrity:W,fetchPriority:P}):Z==="script"&&s.d.X(O,{crossOrigin:w,integrity:W,fetchPriority:P,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},st.preinitModule=function(O,x){if(typeof O=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var Z=L(x.as,x.crossOrigin);s.d.M(O,{crossOrigin:Z,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&s.d.M(O)},st.preload=function(O,x){if(typeof O=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var Z=x.as,w=L(Z,x.crossOrigin);s.d.L(O,Z,{crossOrigin:w,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},st.preloadModule=function(O,x){if(typeof O=="string")if(x){var Z=L(x.as,x.crossOrigin);s.d.m(O,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:Z,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else s.d.m(O)},st.requestFormReset=function(O){s.d.r(O)},st.unstable_batchedUpdates=function(O,x){return O(x)},st.useFormState=function(O,x,Z){return R.H.useFormState(O,x,Z)},st.useFormStatus=function(){return R.H.useHostTransitionStatus()},st.version="19.2.4",st}var Kf;function jh(){if(Kf)return Xu.exports;Kf=1;function d(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(d)}catch(T){console.error(T)}}return d(),Xu.exports=Ch(),Xu.exports}/**
 * @license React
...
`,Mo=(oi.basePath||"/").replace(/\/$/,"");function kg(d){return sm(d,Mo,Qn)}function Ku(d){return ug(d,Mo,Qn)}const fm=cg(window.location.pathname,window.location.hash,Qn,Mo,sm),Lg=cm(fm,Qn,dm);function Hg(){var oe;const[d,T]=H.useState(fm),[h,s]=H.useState(null),[_,j]=H.useState(!0),R=H.useCallback(async(D,V)=>{j(!0),T(D);const K=Ku(D);V!=null&&V.replace?window.history.replaceState(null,"",K):window.history.pushState(null,"",K);const G=await cm(D,Qn,dm);if(s(G),j(!1),!(V!=null&&V.skipScroll)){const he=window.location.hash.slice(1);he?requestAnimationFrame(()=>{const Te=document.getElementById(he);Te&&Te.scrollIntoView({behavior:"smooth",block:"start"})}):window.scrollTo(0,0)}},[]);H.useEffect(()=>{const D=window.location.hash.slice(1);if(D&&Qn.some(V=>V.id===D)){const V=Ku(D);window.history.replaceState(null,"",V),R(D,{replace:!0})}else{const V=Ku(d);window.history.replaceState(null,"",V),Lg.then(K=>{s(K),j(!1)})}},[]),H.useEffect(()=>{const D=()=>{const V=kg(window.location.pathname);V&&V!==d&&R(V,{replace:!0,skipScroll:!0})};return window.addEventListener("popstate",D),()=>window.removeEventListener("popstate",D)},[d,R]);const L=H.useRef(null),[O,x]=H.useState(()=>{var V,K;if(typeof document>"u")return"light";if(document.documentElement.classList.contains("dark"))return"dark";const D=((V=oi.theme)==null?void 0:V.mode)||"auto";return D==="dark"?"dark":D==="light"?"light":(K=window.matchMedia)!=null&&K.call(window,"(prefers-color-scheme: dark)").matches?"dark":"light"});H.useEffect(()=>{const D=new MutationObserver(()=>{const V=document.documentElement.classList.contains("dark");x(V?"dark":"light")});return D.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>D.disconnect()},[]),H.useEffect(()=>{const D=document.querySelectorAll(".tome-mermaid[data-mermaid]");if(D.length===0)return;let V=!1;const K="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";return(async()=>{try{L.current||(L.current=(await import(K)).default);const G=L.current;if(V)return;const he=O==="dark",Te=getComputedStyle(document.documentElement).getPropertyValue("--font-body").trim()||"sans-serif";G.initialize({startOnLoad:!1,theme:he?"dark":"default",fontFamily:Te,flowchart:{padding:15,nodeSpacing:30,rankSpacing:40}});for(let B=0;B<D.length;B++){const Oe=D[B],Je=Oe.getAttribute("data-mermaid");if(Je)try{const Me=atob(Je),{svg:Pe}=await G.render(`tome-mermaid-${B}-${Date.now()}`,Me);V||(Oe.innerHTML=Pe)}catch(Me){console.warn("[tome] Mermaid render failed:",Me),Oe.textContent="Diagram rendering failed",Oe.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"}}}catch(G){console.warn("[tome] Failed to load mermaid from CDN:",G),D.forEach(he=>{he.textContent="Failed to load diagram renderer",he.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"})}})(),()=>{V=!0}},[h,_,O]),H.useEffect(()=>{if(_)return;const D=document.querySelectorAll(".tome-content pre"),V=[];return D.forEach(K=>{if(K.querySelector(".tome-copy-btn"))return;const G=document.createElement("button");G.className="tome-copy-btn",G.textContent="Copy",G.addEventListener("click",async()=>{const he=K.querySelector("code");if(he)try{await navigator.clipboard.writeText(he.textContent||""),G.textContent="Copied!",setTimeout(()=>{G.textContent="Copy"},2e3)}catch{G.textContent="Failed",setTimeout(()=>{G.textContent="Copy"},2e3)}}),K.appendChild(G),V.push(G)}),()=>{V.forEach(K=>K.remove())}},[h,_]);const Z=Qn.map(D=>({id:D.id,title:D.frontmatter.title,description:D.frontmatter.description})),w=Qn.find(D=>D.id===d),W=dg(w,nm),P=sg(oi.editLink,w==null?void 0:w.filePath),ye=(w==null?void 0:w.locale)||(Zu==null?void 0:Zu.defaultLocale)||"en",ne="ltr";return H.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]").length>0;if(!oi.math&&!D)return;const V="tome-katex-css";if(document.getElementById(V))return;const K=document.createElement("link");K.id=V,K.rel="stylesheet",K.href="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.min.css",K.crossOrigin="anonymous",document.head.appendChild(K)},[h,_]),H.useEffect(()=>{const D=document.querySelectorAll(".tome-math[data-math]");if(D.length===0)return;let V=!1;const K="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.mjs";return(async()=>{try{const G=(await import(K)).default;if(V)return;for(const he of D){const Te=he.getAttribute("data-math");if(Te)try{const B=atob(Te),Oe=he.classList.contains("tome-math-block");G.render(B,he,{displayMode:Oe,throwOnError:!1})}catch(B){console.warn("[tome] KaTeX render failed:",B)}}}catch(G){console.warn("[tome] Failed to load KaTeX from CDN:",G)}})(),()=>{V=!0}},[h,_]),u.jsxs(u.Fragment,{children:[u.jsx("style",{children:Ug}),u.jsx(og,{config:oi,navigation:fg,currentPageId:d,pageHtml:h!=null&&h.isMdx?void 0:_?"":(h==null?void 0:h.html)||"<p>Page not found</p>",pageComponent:h!=null&&h.isMdx?h.component:void 0,mdxComponents:Rg,pageTitle:(h==null?void 0:h.frontmatter.title)||(_?"":"Not Found"),pageDescription:h==null?void 0:h.frontmatter.description,headings:(h==null?void 0:h.headings)||[],tocEnabled:(h==null?void 0:h.frontmatter.toc)!==!1,editUrl:P,lastUpdated:w==null?void 0:w.lastUpdated,changelogEntries:h!=null&&h.isMdx||h==null?void 0:h.changelogEntries,onNavigate:R,allPages:Z,docContext:pg,versioning:nm||void 0,currentVersion:W,basePath:Mo,isDraft:((oe=w==null?void 0:w.frontmatter)==null?void 0:oe.draft)===!0,dir:ne,i18n:void 0,currentLocale:ye,overrides:hg})]})}const im=document.getElementById("tome-root");im&&wh.createRoot(im).render(u.jsx(Hg,{}));export{H as a,om as e,u as j,jh as r};
