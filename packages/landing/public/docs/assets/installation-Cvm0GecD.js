...
`]})]})}function o(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(d,{...r})}):d(r)}function s(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const l={frontmatter:{title:"Installation",description:"System requirements and detailed installation instructions for Tome.",icon:"download",hidden:!1,toc:!0,draft:!1},headings:[{depth:2,text:"Prerequisites",id:"prerequisites"},{depth:2,text:"Create a new project",id:"create-a-new-project"},{depth:2,text:"Install dependencies",id:"install-dependencies"},{depth:2,text:"Start the dev server",id:"start-the-dev-server"},{depth:2,text:"Add to an existing project",id:"add-to-an-existing-project"},{depth:2,text:"Next steps",id:"next-steps"}]};export{o as default,l as meta};
