const e={frontmatter:{title:"File-System Routing",description:"How Tome maps files in the pages/ directory to URLs — naming conventions, nested routes, i18n, and versioning.",hidden:!1},html:`<h1 id="file-system-routing"><a class="heading-anchor" aria-hidden tabindex="-1" href="#file-system-routing"><span class="icon icon-link"></span></a>File-system routing</h1>
