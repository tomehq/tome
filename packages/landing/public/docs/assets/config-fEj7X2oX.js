const n={frontmatter:{title:"Config Reference",description:"Complete reference for every field in tome.config.js — types, defaults, and descriptions.",icon:"file-text",hidden:!1},html:`<h1 id="config-reference"><a class="heading-anchor" aria-hidden tabindex="-1" href="#config-reference"><span class="icon icon-link"></span></a>Config reference</h1>
<p>The config file (<code>tome.config.js</code>, <code>.mjs</code>, or <code>.ts</code>) is validated at startup. Invalid values produce clear error messages with the field path and expected type.</p>
