const n={frontmatter:{title:"Pages & Routing",description:"How Tome maps files in the pages/ directory to URLs — naming conventions, nested routes, i18n, and versioning.",icon:"map",hidden:!1,toc:!0,draft:!1},html:`<p>Every <code>.md</code> or <code>.mdx</code> file in the <code>pages/</code> directory becomes a page. The file path determines the URL.</p>
